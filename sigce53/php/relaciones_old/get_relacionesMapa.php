<?php
    ...
    $arrCliente = array();
      ...
      $count =0;
       ...
       $ps_coner->close();
      array_push($arrCliente, array("marca" => $marca_comer, "productores" => $arrProductores,"envasadores"=>$arrEnvasadores[$count],"comercializadores"=>$arrComercializadores[$count]));
       $count ++;
		  }
