...
class TCPDF {
	 ...
	 */
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false,$stringH="S/N") {
		/* Set internal character encoding to ASCII */
		$this->stringHeader=$stringH;
	...
	public function getStringHeader(){
