	...
	$.ajax({
        ...
        var cir_proveedores = ``;
				...
				for (var i = 0; i < data.marcas.length; i++) {
					...
					panel += `<div class="col-lg-12"><h4 style="font-weight: bold;  background: #5cb85c94;  padding: 10px;">Marca: ${marca}</h4><div class="panel panel-default col-lg-3"><div class="panel-heading"><h4 class="panel-title"><b>Productores</b></h4></div>`;
					...
					panel += `<div class="panel panel-default col-lg-3"><div class="panel-heading"><h4 class="panel-title"><b>Proveedores</b></h4></div>`;
					panel += `<div class="panel-body" style="font-size:16px; min-height: 200px;">`;
					for (var m = 0; m < data.marcas[i].proveedores.length; m++) {
						proveedor = data.marcas[i].proveedores[m];
					...
					panel += `<div class="panel panel-default col-lg-3"><div class="panel-heading"><h4 class="panel-title"><b>Envasadores</b></h4></div>`;
					panel += `<div class="panel-body" style="font-size:16px; min-height: 200px;">`;
					...
					panel += `<div class="panel panel-default col-lg-3"><div class="panel-heading"><h4 class="panel-title"><b>Comercializadores</b></h4></div>`;
					panel += `<div class="panel-body" style="font-size:16px; min-height: 200px;">`;
