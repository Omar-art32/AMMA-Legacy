...
function busc_multi()
{
	...
	var edo_f=$("#cbo_edo").val();
	var cat_f=$("#cbo_cat").val();
	filtra_rep(cliente_f,4,marca_f,tipo_m,fecha_1,fecha_2,edo_f,cat_f);	
}

function filtra_rep(ncliente, tipo_f, nmarca,tipom,fech_1,fech_2,nedo,ncat)
{
  $("#jqGrid").clearGridData();
  jQuery("#jqGrid").setGridParam({postData:{'cliente':ncliente, 'tipo':tipo_f, 'marca':nmarca, 'tipo_m':tipom, 'fecha1':fech_1, 'fecha2':fech_2,'estado':nedo,'categoria':ncat},page:1}).trigger("reloadGrid");
