...
function drawChartA() {
  ...
  Object.entries(data).forEach(function (row) {
    chartDataA.push([
      row[1].nMes,
      parseInt(row[1].m2022),
      parseInt(row[1].m2023),
      parseInt(row[1].m2024),
      parseInt(row[1].m2025),
      parseInt(row[1].m2026),
      parseInt(row[1].promedio)
    ]);
  });
  ...
  var container = document.getElementById('piechart_barrasA');
