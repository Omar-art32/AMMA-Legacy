...
function fill_sincronizar()
{
	...
	else
	{
	  ...
	  $("#jqGrid_sinc").jqGrid({
		  ...
		  datatype: "json",
		  colModel: [
			  { label: 'Recibo', name: 'id_recibo', width: 65, align:'center', sortable:true },
			  { label: '# de Control', name: 'cliente', width: 55, sortable:true, align:'center' },
			  { label: 'Marca', name: 'marca', width: 140 },
			  { label: 'Estado', name: 'edo', width: 80},
			  { label: 'Categoria', name: 'tipo_mez', width: 80},	  
			  { label: 'Serie', name: 'serie', width: 40, align:'center'},
			  { label: 'Solicitud', name: 'solicitud', width: 90, align:'center'},
			  { label: 'Fol. Inicial', name: 'fol_ini', width: 90, align:'center' },
			  { label: 'Fol. Final', name: 'fol_fin', width: 90, align:'right' },
			  { label: 'Cantidad', name: 'cantidad', width: 70, align:'center'},
			  { label: 'Verificar', name: 'verificar', width: 60, align:'center'}                  
		  ],
		  loadComplete : function() { 
