...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <?php if($_SESSION[$d_s]['cargo']==14||$_SESSION[$d_s]['cargo']==13){?>
                                ...
                                <?php }
                                if($_SESSION[$d_s]['cargo']==14||$_SESSION[$d_s]['cargo']==20||$_SESSION[$d_s]['cargo']==7||$_SESSION[$d_s]['cargo']==13||$_SESSION[$d_s]['cargo']==28){?>
                                 ...
                                 <div id="entradas" style="display:flex;">           
                                    <div class="col-lg-8">
                                          ...
                                          <div id="datos_entrega"><!-- Contenido Inventario-->
                                              ...
                                              <?php if($_SESSION[$d_s]['cargo']==13 && $_SESSION[$d_s]['sec_lvl_1_2']==1){?> 
                                             ...
                                             <div class="form-group" > 
                                                ...
                                                <div class="col-lg-7"  style="padding-left:5px; padding-right:5px;"> 
                                                    <div id="tot_existe" class="ui-widget-content ui-corner-all" style="display:none; font-size:12px;">                    
                                                    </div>                                    
                                                </div>
                                              </div>   
                                              <?php }?>
                                         ...
                                         <div class="col-lg-4">                
                                           <div id="toggle_vista" class="toggler" style="width:100%; display:none;">
                                             ...
                                             <div id="lista_exist" class="ui-widget-content ui-corner-all" style="margin-right:-3px; padding:0 !important; display:none; font-size:12px;">                       
                                             </div>
                                           </div>
                                         </div><!-- colo-lg-4 -->
                                      </div>  
                                              ...
                                              <div id="opt_invent"><!-- Inicia Opciones Req -->
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div class="form-group" id='txt_cliente_req'>
                                                        <label for="formReq" class="col-lg-3 control-label">Asociado:</label>
                                                        <div class="col-lg-9">
                ...
                if($_SESSION[$d_s]['cargo']==14||$_SESSION[$d_s]['cargo']==7||$_SESSION[$d_s]['cargo']==20||$_SESSION[$d_s]['cargo']==13||$_SESSION[$d_s]['cargo']==28)
                {
                 ?>
                               ...
                               <div role="tabpanel" class="tab-pane" id="tabSolicitados"><!-- /.tab-pane Solicitados--> 
                                   <form class="form-horizontal" id="frm_search" name="frm_search" role="form" method='post'> 
                                            <div class="form-group" id="search_by_noc">
                                                ...
                                                <label for="frm_search" class="col-md-2 control-label">ID Asociado:</label>
                                                <div class="col-md-2" style="padding-left:2px; margin-left:auto;">
                                                          ...
                                                          <form class="form-horizontal" id="frmEditPO" name="frmEditPO" target="_blank"  role="form" action='' method='post'>
                                                              ...
                                                              <div class='col-lg-12'>                                                
                                                                <div class="form-group" id='div_socio'>
                                                                   <label for="formReq" class="col-lg-4 control-label">No Cliente:</label>
                                                                   <div class="col-lg-7">
  ...
  <script src="../js/validate/additional-methods.js"></script>
    ...
    <script src="js/inventario/pedidos_online.js"></script> 
    <script src="js/inventario/entradas.js"></script>
    <script src="js/inventario/comun.js"></script>  
  <?php if($_SESSION[$d_s]['cargo']==14||$_SESSION[$d_s]['cargo']==13){?>
   <script src="js/inventario/requisicion.js"></script>   
  <?php }   
  if($_SESSION[$d_s]['cargo']==14||$_SESSION[$d_s]['cargo']==7||$_SESSION[$d_s]['cargo']==20||$_SESSION[$d_s]['cargo']==13||$_SESSION[$d_s]['cargo']==28){?>
   <script src="js/inventario/listado.js"></script>         
  <?php }?> 
