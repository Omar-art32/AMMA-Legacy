<?php
  try
  {
	...
	$sql_remota="";
	$val_pedido="";
    $sql_ins="INSERT INTO h_pedidos(id_sh_d,no_pedido,fecha,no_cliente,edo,marca,serie,tipo,fi,ff,cantidad,pagado,urgente,status,usr)(SELECT id_sh_d, no_pedido, '$fecha', no_cliente, edo, marca, serie, tipo, fi, ff, cantidad, pagado, urgente,0,'$user' FROM h_tmp_pedido WHERE no_pedido=$no_pedido and pagado=1);";
