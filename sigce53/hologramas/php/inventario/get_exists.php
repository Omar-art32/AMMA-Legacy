<?php
/**
 * get_exists.php — PHP 8.3 (hologramas/php/inventario/, usado por requisicion.js)
 ...
 *
 * NOTA: es prácticamente idéntico a hologramas/php/get_exists.php (usado por
 * entradas.js), salvo que aquí sí se trunca $client a 4 caracteres antes de
 * la consulta (comportamiento original conservado).
 */
