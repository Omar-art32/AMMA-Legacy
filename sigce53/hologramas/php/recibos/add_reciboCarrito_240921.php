...
$nota1 = utf8_decode("El asociado y/o cliente del CRM se obliga a utilizar los folios de hologramas entregados para los lotes descritos en la solicitud de ingreso, en caso de utilizar dichos hologramas en lotes distintos a los mencionados en el presente acuse, los lotes deberán ser certificados o en proceso de certificación, por lo que deberá notificar al verificador en turno dicho uso para que constate el cumplimiento con la NOM Mezcal vigente y quede manifestado en dictamen. En caso contrario se procederá a cancelar los hologramas y no se realizará la emisión de los certificados correspondientes.");
...
try
{
    ...
    foreach ($arr_data as $h => $id) {
        ...
        for ($x = 0; $x < $n_r; $x++) {
            ...
            $ps_ins->bind_param("iissssisssiiissssiss", $recibo, $anio_r, $cliente, $marca, $serie, $edo, $tipo, $sol, $destino, $fecha_e, $fi, $ff, $mermas, $fol_m1, $fol_m1_num, $motivo_merma, $obs_ent, $total, $fecha, $usr);
            if ($borrar_fila == 1) {
    ...
    $dir_file = "http://" . $svr_dir . "/siigv2/hologramas/php/recibos/pdf_recibos/" . $file;
    //Redirect
