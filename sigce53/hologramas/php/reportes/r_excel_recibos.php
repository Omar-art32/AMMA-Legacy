...
if(isset($_SESSION[$d_s]))
{
	...
	else if($_SESSION[$d_s]["logged"] == "OK" &&  $_SESSION[$d_s]["seccion_1_4"]=="logged")
	{
		...
		if(isset($_POST['fechaini'])){
			...
			$he1 = "";
			$msj1 = "";
			$file_name = 'recibos_' . random_int(0, mt_getrandmax()) . '.xlsx';
			$operador = " where ";
			...
			//echo $consulta;
				...
				$spreadsheet->getActiveSheet()->getStyle('A'.$r_h.':P'.$r_h)->applyFromArray($styleArray2);
				...
				while($fila= $res->fetch_assoc())
				{
					  ...
					  //MARCA
					  $arr_fila[2]=mb_convert_encoding($fila["marca"], 'UTF-8', 'ISO-8859-1');
					  if($arr_fila[2]==""){
						 $arr_fila[2]="N/A";
					  }
					  //CLAVE
				...
				// Rename worksheet
				$spreadsheet->getActiveSheet()->setTitle('RecibosEntregados');
