    ...
    if ($password == null) {
        ...
        if ($result != false) {
            ...
            if ($num_rows > 0) {
                ...
                $sql_acc = "SELECT * FROM a_usuarios WHERE a_usuarios.login= '$username' and a_usuarios.password='$contra' AND a_usuarios.status=1";
                ...
                if ($result_acc != false) {
                    ...
                    if ($num_rows_acc > 0) {
                        ...
                        if ($datosPersonal["verificar_ip"]==1 && $datosPersonal["ip"] !=  get_real_ip()){
                                    ...
                                    if ($enlaces == "") {
                                        $enlaces .= '<li>
											  ...
											  <ul class="nav nav-second-level">
												  <li>
													  <a href="' . $protocolo . '//' . $svr_dir . '/sigce53/' . $url . '?d_s=' . $r_k . '">-- ' . $row['nom_sec'] . '</a>
												  </li> ';
                                    } else {
                                        $enlaces .= '</ul></li><li>
											  <a href="#" class="dropdown-collapse"><i class="fa ' . $row['icono'] . ' fa-fw"></i><span class="side-menu-title"> ' . $row['n_mod'] . '</span><span class="fa arrow"></span></a>
                            ...
                            $url_ini = $protocolo . '//' . $svr_dir . '/sigce53/index.php?d_s=' . $r_k;
