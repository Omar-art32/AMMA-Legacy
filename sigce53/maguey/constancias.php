...
<head>
    ...
    <script src="js/acciones_constancias.js?24042021"></script>
    <script src="media/js/obtendatospv.js?009"></script>
        ...
        <div id="page-wrapper">
            <div class="row panel-pincipal">
              <div class="col-lg-12" align="center">
                <h3 class="page-header text-white">REGISTRO DE MAGUEY</h3>                    
              </div>
            </div>
            <div class="row">
                ...
                <div class="panel  panel-che" style="max-width:1100px; margin-left: auto !important; margin-right:auto !important; margin-bottom:75px;">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="tab-content">
                                                  ...
                                                  <form class="form-horizontal" id="formmodal" action="" method="POST" name="formmodal" enctype="multipart/form-data" >
                                                    <div class="modal-body ">
                                                      ...
                                                      <div class=" row">
                                                        ...
                                                        <div class="col-md-2">
                                                           <label for="formmodal">No. de Control</label>
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab4success">
                            <div style="margin-left:auto !important; margin-right:auto !important;">
                                <div class="panel  panel-default" style="margin-bottom:0 !important; margin-top:5px !important;">
                                    <div class="panel-heading" style="text-align:center; font-size:16px; font-weight:bold;">Constancia de Extracción de Viveros
                                    </div>
                                    <div class="panel-body">
                                        <table id="example_viex" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th># Vivero</th>
                                                    <th># de Control</th>
