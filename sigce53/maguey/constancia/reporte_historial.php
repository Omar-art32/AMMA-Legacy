...
function Footer()
{
	...
	$correoTexto = ($filaClientes['correo'] == "") ? '---' : utf8_decode($filaClientes['correo']);
	...
	$pdf->SetXY($xTel, $yRow);
	$pdf->SetFont('Calibri-Bold','',10);
	$pdf->Cell(45, $rowH, utf8_decode('TELÉFONO: '), 0, 0, 'C');
	...
	$pdf->SetFont('Calibri-Bold','',10);
	$pdf->Cell(45, $rowH, utf8_decode('CORREO ELECTRÓNICO: '), 0, 0, 'C');
