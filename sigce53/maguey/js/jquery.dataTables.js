	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sInfoPostFix": "", //Resultado 1 - 10 de 1,016 registros
				"sSearch": "Buscar:",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "Primero",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" style="padding: 6px 10px; margin: 3px 0;display: inline-block; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;"/> ';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select size="1"  style="padding: 6px 10px; margin: 8px 0;display: inline-block; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;"'+sName+'>';
			//var sStdMenu = '<select class="form-control"'+sName+'>';
			var i, iLen;
